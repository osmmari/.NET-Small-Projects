...
/*  Господи, я ненавижу эту задачу. Съела весь мой выходной и все нервы.
    Если будете заимствовать мое решение, и оно вдруг не пройдет, поиграйте с эксепшенами.
    Когда я сдавал задачу, у меня на каждую функцию приходилось по эксепшену.
*/
...
namespace GeometryPainting
{
    public static class SegmentExtensions
    {
        ...
        {
            if (segment1.Begin != null && segment2.Begin != null && segment1.End != null && segment2.End != null)
            {
